...
class PythonGenerator(Generator):
    ...
    def _render_module(self, module):
        ...
        # Render the module.
        template = self.templates.get(MODULE_TEMPLATE)
        return template.render(imported_modules=module.imported_modules, definitions=definitions,
    ...
    def _render_definition(self, def0):
        ...
        try:
            ...
            return template.render(definition=def0, **def0.__dict__)
        finally:

...
public class RestClientTest {
	...
	public void testInvoke() throws Exception {
		...
		RestClient<TestInterface> client = new RestClient<TestInterface>(TestInterface.DESCRIPTOR,
				session);
	...
	private Invocation getInvocation(final int arg0, final int arg1) {
		return Invocation.root(TestInterface.DESCRIPTOR.getMethod("testIndex"),
